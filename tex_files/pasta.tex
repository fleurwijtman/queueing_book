...
Why is $\mu e^{-\mu t}$ not a reasonable for the
...
The simplest guess for the inter-departure might be $\lambda e^{-\lambda t}$; so this is what we will try to prove. As we will see, this result holds. 
